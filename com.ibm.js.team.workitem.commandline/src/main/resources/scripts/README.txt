...
-printworkitem {switch} {parameter[:mode]=value}
...
-importworkitems /importdebug password="value" /skipEmailNotification projectArea="value" /importmultipass importFile="value" /forcelinkcreation /enforceSizeLimits repository="value" /ignoreErrors user="value"   [mappingFile="C:\temp\mapping.xml"] [encoding="UTF_16LE"][timestampFormat="MMM d, yyyy hh:mm a"] [delimiter=","]
...
-update password="value" /skipEmailNotification /enableDeleteApprovals id="value" /enforceSizeLimits repository="value" /ignoreErrors user="value" /enableDeleteAttachment  {parameter[:mode]=value}
