 ...
 * 
 */
public class ValidateUserAllocationsRESTCommand extends AbstractTeamRepositoryCommand implements IWorkItemCommand {

	private Logger logger = LogManager.getLogger(ValidateUserAllocationsRESTCommand.class);
	 ...
	 */
	public ValidateUserAllocationsRESTCommand(ParameterManager parameterManager) {
		super(parameterManager);
	}

	@Override
	public String getCommandName() {
		return IWorkItemCommandLineConstants.COMMAND_VALIDATE_USER_ALLOCATIONS_REST;
	}
